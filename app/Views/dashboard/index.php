...
<main class="main-content">
    <div class="container-fluid">
        ...
        <section class="mb-5">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 mb-4"><div class="action-card" data-bs-toggle="modal" data-bs-target="#formInputModal"><div class="icon"><i class="fa-solid fa-pen"></i></div><h3>Form Input</h3><p>Masukan semua data transaksi seperti penjualan, pengadaan, dan stok opname.</p></div></div>
                <div class="col-lg-4 col-md-6 mb-4"><div class="action-card" data-bs-toggle="modal" data-bs-target="#laporanModal"><div class="icon"><i class="fa-solid fa-chart-pie"></i></div><h3>Laporan</h3><p>Lihat semua laporan penting seperti kartu stok, mutasi produk, dan lainnya.</p></div></div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body p-4"><div class="row">
                <div class="col-md-6 mb-3"><a href="<?= site_url('pengemasan') ?>" class="modal-link-card"><div class="icon-wrapper"><i class="fa-solid fa-box"></i></div><div class="link-text"><strong>Input Pengemasan</strong><small>Catat hasil produksi.</small></div></a></div>
